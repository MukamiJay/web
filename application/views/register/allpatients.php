...
<div class="container" style="margin-bottom: 10px" align="center">
    <div>
        <div class="container-fluid" style="alignment:right">
        <?php
        echo $this->session->flashdata('success');
        ?>
        </div>
        <div class="well well-lg " style="background: transparent ; border: transparent ; margin-bottom: 25px" >
            <div class="col-sm-10" style="color: black; font-size: 150%" >Available Patients</div>
            <div class="col-sm-2" ><a data-toggle="modal" data-target="#myModal" style="color: black; font-size: 130%; border-bottom: solid">Register Today</a></div>
        </div>
    </div>
</div>
<div>
                        ...
                        <div id='leftmenuinner'>
                            <div class='w3-light-grey' id='leftmenuinnerinner'>
                                <ul class="nav nav-pills nav-stacked" role="tablist">
                                    ...
                                    <li><a href="http://localhost/sample/index.php/donor/view">Donors</a>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="table-striped">
                    ...
                    <table id="alldonors" style="" >
                        ...
                        <tr>
                            <?php
                            if (!empty($patients)) {
                                foreach ($patients as $patient) // user is an object.
                                {
                                    echo "<tr>
<td> " . $patient->id . "</td>
<td> " . $patient->Name . "</td>
...
<td>
<a href=\"http://localhost/sample/index.php/patient/delete?id=". $patient->id."\" class='btn' style='color:blue; font-size: 20px'>Delete</a> 
</td>
";
                                }
                            }
